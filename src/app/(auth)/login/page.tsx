  ...
  return (
    <div>
      <form action={login} className="flex flex-col gap-4">
        ...
        {message && (
          <p className="border-l-4 border-blue-500 bg-blue-50 px-3 py-2 text-sm text-blue-700 dark:bg-blue-950 dark:text-blue-300">
            {message}
          </p>
        )}
        {error && (
      ...
      <p className="mt-6 text-center text-sm text-slate-500 dark:text-slate-400">
        No account?{" "}
        <Link href="/signup" className="font-medium text-[#0036AF] underline dark:text-[#5B9BEA]">
          Sign up
        </Link>
      </p>
    </div>
